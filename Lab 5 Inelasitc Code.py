...
### 1: velocity
v_Ai = 0.2318  #initial velocity (from statistics analysis of velocity graph)
dv_Ai = 0.0009581  #uncertainty of "

v_Bi = -0.1969  #cart B at rest at beginning
dv_Bi = 0.009109 

v_Af = 0.02142    #final velocity (from statistics analysis of velocity graph)
dv_Af = 0.001574  #uncertainty of "
...
### 3: Kinetic Energy for Inelastic
...
#This is for Inelastic KE calculation 
...
print("Intial Inelastic Kinetic Energy of Cart A:",ke_Ai,"±",dke_Ai," Joules") #print the intial 
#kinetic energy and its uncertainty
print("Intial Inelastic Kinetic Energy of Cart B:",ke_Bi,"±",dke_Bi," Joules") #print the intial 
#kinetic energy and its uncertainty

print("Final Inelastic Kinetic Energy of Cart A:",ke_Af,"±",dke_Af," Joules") #print the final
#kinetic energy and its uncertainty
print("Final Inelastic Kinetic Energy of Cart B:",ke_Bf,"±",dke_Bf," Joules") #print the final
#kinetic energy and its uncertainty
